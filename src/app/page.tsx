  ...
  return (
    <Layout>
      ...
      <div className="py-8 max-w-xl w-full px-4 md:px-0">
        <ThemeSwitcher />
        <h1 className="text-[24px] text-center mt-4">hi, i&apos;m abee. i build things and make content about it. known mostly for hackathons and meme coins...</h1>
        ...
        <iframe 
          className='mt-8 border border-[var(--gray-600)] p-3 object-cover mx-auto items-center justify-center'
